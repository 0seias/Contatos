...
public class BancoDeDados extends SQLiteOpenHelper
{
    ...
    public Contatos consultaContato (int id)
    {
        ...
        Cursor cursor = banco.query(TABELA_CONTATOS, new String[] {CAMPO_ID, CAMPO_NOME,
                        CAMPO_CELULAR},
        ...
        Contatos contatos = new Contatos(Integer.parseInt(cursor.getString(0)),
                cursor.getString( 1),
                cursor.getString(2));
        return contatos;
    }
    ...
    public int atualizaContatos (Contatos contatos)
    {
        ...
        values.put(CAMPO_NOME, contatos.getNome());
        values.put(CAMPO_CELULAR, contatos.getCelular());
        return banco.update(TABELA_CONTATOS, values, CAMPO_ID + "=?", new String[]
                {String.valueOf(contatos.getId())});
    }
    public void deletaContatos(Contatos contatos)
    {
        ...
        SQLiteDatabase banco = this.getWritableDatabase();
        banco.delete(TABELA_CONTATOS, CAMPO_ID + "=?", new String[]
                {String.valueOf(contatos.getId())});
        banco.close();
    }
